"""Blind Hangman by Lance Wilson
Guess the letters to a secret word before the hangman is drawn, but there's a twist: you can't see the letters!

Original Game: Hangman, by Al Sweigart al@inventwithpython.com
        ...
        if guess in secretWord:
            ...
            for secretWordLetter in secretWord:
                if secretWordLetter not in correctLetters:
                    ...
                    break
            if foundAllLetters:
                print(f"""Yes! You got the secret word! Try to guess it, or you lose all progress!
Do you know what it is? Type 'no' if you can't guess it, and we'll let you off the rope.
You get extra points if you do, so guess here:""")
                wordGuess = input()
                if wordGuess.upper() == secretWord:
                    print('Yes! The secret word is:', secretWord)
                    print('You got the extra credit!')
                    bonus = True
                elif wordGuess.upper() == "NO":
                    print('I do not blame you. You did your best, and that is enough for me.')
                else:
                    print('The word was "{}"'.format(secretWord))  # These lines offer another challenge: actually
                    # guessing the word! If they do guess it, they get a bonus. If they refuse to guess it, they are
                    # released, and if the player guesses wrong, he loses.
                    lostGame = True
...
def drawHangman(missedLetters, correctLetters, secretWord):
    ...
    for _ in missedLetters:
        print("*", end=' ')  # this time, the player doesn't see the letter.
    ...
    for i in range(len(secretWord)):
        if secretWord[i] in correctLetters:
            blanks[i] = "*"  # player doesn't see guess
