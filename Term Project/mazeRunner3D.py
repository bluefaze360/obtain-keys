...
def main():
    ...
    while not gameQuit: # User-friendly warning
        while True:
            ...
            if os.path.exists("Mazes/maze" + filename + ".txt"):
                break
...
def runMaze():
    ...
    mazeFile = open("Mazes/maze" + filename + ".txt")
    maze = {}
